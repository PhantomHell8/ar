...
// DEVELOPER INFO
//YOUTUBE : Zero YT7 ( BASE )
//YOUTUBE : ABIL BOTZ ( RECODE )
//MAAP GW RECODENYA DIKIT LAGI G ADA WAKTU SOALNYA MWHEHEHE

//GANTI OWNER DLL DI setting.json
...
creator = 'Zero YT7' // GAK USAH DI UBAH ANJING HARGAI CREATOR
recode = 'ABIL BOTZ' // G USH DIGANTI
...
const daftar2 = 'Jangan Lupa Subscribe ABIL BOTZ\nhttp://bit.ly/3nEyhWk'
...
📢 JANGAN LUPA SUBSCRIBE YOUTUBE ABIL BOTZ
📢 http://bit.ly/3nEyhWk
`
...
but = [
        ...
        sendButImage(from, teks, "©ABIL BOTZ", gam, but)
break
...
but = [
        ...
        sendButImage(from, teks, gam, but)
break
case 'gopay':
if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted: ftrol})
but = [
...
gam = fs.readFileSync('./zeroyt7/zerothumb.jpg')
but = [
          { buttonId: `${prefix}menu`, buttonText: { displayText: '🏷️MENU' }, type: 1 }
        ]
        sendButImage(from, kimak, "©ABIL BOTZ", gam, but)
break
case 'donasi':
...
Semoga Rejekinya Tambah Lancar Amin
    ...
    ╭───────────────❏
❍┤ヅ Gopay : https://bit.ly/qrgopay
❍┤ヅ Dana : https://bit.ly/qrgopay
❍┤ヅ Ovo : https://bit.ly/qrovo
❍┤ヅ Pulsa : 082293295376
    ╰───────────────❏`
gam = fs.readFileSync('./zeroyt7/zerothumb.jpg')
but = [
          { buttonId: `${prefix}owner`, buttonText: { displayText: '👤OWNER' }, type: 1 },
